...
class NetworkDataManager {
    ...
    private func buildUrl(path: String? = nil, version: String? = nil, endpoint: String, queryItems: [URLQueryItem]) throws -> URL {
        guard let url = URL(string: "https://pro.openweathermap.org")?
    ...
    func fetchWeather<T: Decodable>(lat: Double, lon: Double, units: String = "metric", cnt: Int? = nil, endpoint: String) async throws -> T {
        var queryItems = [
